...
from sqlalchemy import Identity, JSON, Boolean, DateTime, Integer, String, func
...
class LLM(Base):
    ...
    expire_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True, comment="过期时间")
